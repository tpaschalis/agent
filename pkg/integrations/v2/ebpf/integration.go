...
import (
	...
	ebpf_config "github.com/tpaschalis/ebpf_exporter/config"
	"github.com/tpaschalis/ebpf_exporter/exporter"
	"gopkg.in/yaml.v2"
...
func createHandler() http.HandlerFunc {
	content, err := ioutil.ReadFile("/home/tpaschalis/agent/pkg/integrations/v2/ebpf/ebpf_config.yaml")
	if err != nil {
		panic(err)
	}
