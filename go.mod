...
require (
	...
	github.com/grafana/loki v1.6.2-0.20221204181246-85392a9728b3
	...
	github.com/prometheus-operator/prometheus-operator v0.61.1
...
require (
	...
	github.com/thanos-io/thanos v0.29.0 // indirect
